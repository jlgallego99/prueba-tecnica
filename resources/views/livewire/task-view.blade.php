@if ($confirmDelete)
    <form wire:submit.prevent="deleteTask" class="fixed inset-0 z-100 flex items-center justify-center bg-black/50">
            ...
            <div class="bg-gray-200 rounded-lg shadow">
                ...
                <div class="flex justify-end space-x-4 p-4">
                    <button type="button" wire:click="cancelDelete"
                        class="px-4 py-2 rounded-lg hover:underline cursor-pointer">
                        Cancel
                    </button>
                    <button type="submit"
                        class="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-400 cursor-pointer">
                        Delete
                    </button>
                </div>
            </div>
